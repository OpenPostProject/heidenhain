/**
  ...
  $Revision: 44090 1540130b87322f674ba6e0ad54e2ece16d525b85 $
  $Date: 2023-09-25 23:24:32 $
...
function onCyclePoint(x, y, z) {
  ...
  if (isProbeOperation()) {
    ...
    if (getProperty("toolAsName") && cycle.updateToolWear == 1 && cycle.toolDescription.toUpperCase() == "") {
      warning(localize("The description of the tool to be updated is empty. It will not be updated."));
    }
    var Q330 = "";
    if (getProperty("toolAsName")) {
      Q330 = "  QS330=" + (cycle.updateToolWear == 1 ? "\"" + (cycle.toolDescription.toUpperCase()) + "\"" : "\"\"") + " ;" + localize("TOOL NAME");
    } else {
